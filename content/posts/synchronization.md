...
To understand where the need for synchronization comes from I think it's good to have a mental model of how the system works. Even if the model is simpler than the real hardware and not always accurate, it can help build some intuition and provide good first answers to questions that arise while designing systems that require manual synchronization.
